...
create table orders (
  o_id int not null, 
  o_d_id numeric(3,0) not null, 
  o_w_id smallint not null,
  o_c_id int,
  o_entry_d timestamp,
  o_carrier_id numeric(3,0),
  o_ol_cnt numeric(3,0), 
  o_all_local numeric(3,0),
  constraint orders_pk primary key (o_w_id, o_d_id, o_id)
);

create table new_orders (
  no_o_id int not null,
  no_d_id numeric(3,0) not null,
...
create table order_line ( 
  ...
  ol_d_id numeric(3,0) not null,
  ol_w_id smallint not null,
  ol_number numeric(3,0) not null,
  ol_i_id int, 
  ol_supply_w_id smallint,
  ol_delivery_d timestamp, 
  ol_quantity numeric(3,0), 
